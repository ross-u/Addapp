...
import {
  ...
  storeMyProfile,
  storeContacts,
  storeFriendsProfileJSONString,
  storeFriendsProfileInView
...
const mapActionToProps = dispatch => ({
  storeFriendsProfileInView: profile =>
    dispatch(storeFriendsProfileInView(profile)),
  storeFriendsProfileJSONString: JSONString =>
    dispatch(storeFriendsProfileJSONString(JSONString)),
